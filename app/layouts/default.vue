...
<template>
  <div>
    <UHeader>
      ...
      <template #right>
        <UColorModeButton @click="handleSetTheme" />

        <Button to="/give" class="ml-4 max-md:hidden"> Watch Live </Button>
      </template>
    ...
    <!-- Footer -->
    <UFooter
      class="bg-primary/10 dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 pb-20"
    >
      <template #left>
      ...
      <div class="flex flex-col gap-4">
        ...
        <p class="text-muted text-sm text-center">
          Copyright © {{ new Date().getFullYear() }} Agape Reaching People
          Ministries Inc. - La Trinidad
        </p>
      </div>
        ...
        <div class="flex flex-col">
          <div>
            <UButton
              ...
              color="neutral"
              variant="ghost"
              to="https://www.facebook.com/arpmbenguetph"
              target="_blank"
              aria-label="Facebook"
            />
            <UButton
          ...
          <Button to="/watch" class="mt-4"> Watch Live </Button>
        </div>
      </template>
    </UFooter>
  </div>
