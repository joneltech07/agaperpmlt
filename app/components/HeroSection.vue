<template>
	<div class="h-70 md:h-167.5 p-0 w-full relative bg-slate-800 overlow-hidden">
		<img src="/images/agape.jpg" alt="Hero Image"
			class="w-full h-70 md:h-full object-cover opacity-50 select-none pointer-events-none" draggable="false"
