<template>
  <div
    class="flex flex-col justify-end p-2 rounded-2xl overflow-hidden relative dark:border dark:border-primary w-full md:w-50 min-h-90 bg-primary dark:bg-slate-800 shadow-lg dark:shadow-none">
